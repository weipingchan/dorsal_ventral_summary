function [having_tail_f, firstColLastRow_L_all, firstColLastRow_C_all, firstColLastRow_L_all_cm] = intAllTailParameter_spp(spp_tail_dat_L,scale_L_spp, scaling_factor_listH_L, mat_res)
