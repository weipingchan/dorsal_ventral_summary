...
scaling_factor_listH_L=[scaling_factor_listH2(:,1),scaling_factor_listH2(:,3)]; %dorsal and ventral of left hindwing
scaling_factor_listH_R=[scaling_factor_listH2(:,1),scaling_factor_listH2(:,3)]; %dorsal and ventral of right hindwing
...
having_tail_spp=(having_tail_L+having_tail_R)>0; %List specimen with extended wing regions
